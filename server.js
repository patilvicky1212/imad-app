...
var articles = {
    ...
    'article-three': {
    title: 'Article Three | Amey Patil',
...
app.get('/articles/:articleName', function(req, res) {
  ...
  pool.query("SELECT * FROM article WHERE title = $1", [req.prams.articleName], function (err, result) {
     if (err) {
         res.status(500).send(err.toString());
     } else {
